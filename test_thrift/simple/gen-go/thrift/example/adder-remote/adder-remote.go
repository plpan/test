...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  Numbers addNumber(Numbers a, Numbers b)")
	fmt.Fprintln(os.Stderr)
	os.Exit(0)
}
...
func main() {
	...
	client := example.NewAdderClientFactory(trans, protocolFactory)
	...
	case "addNumber":
		if flag.NArg()-1 != 2 {
			fmt.Fprintln(os.Stderr, "AddNumber requires 2 args")
			flag.Usage()
		}
		arg8 := flag.Arg(1)
		...
		value1 := argvalue1
		fmt.Print(client.AddNumber(value0, value1))
		fmt.Print("\n")
		break
	case "":
		Usage()
